...
export declare type ChatProvider = 'Discord' | 'Twitch';
export declare type ChatOrder = 'Ascending' | 'Descending';
...
export declare type GetSentKudosResponse = SentKudo[];
export declare type GetReceivedKudosResponse = ReceivedKudo[];
export declare type GetChatSummaryResponse = ChatSummary;
export declare type AlertType = 'Sentiment' | 'Other';
